...
class STICK_API Image
{
  public:
    ...
    virtual void resize(stick::Size _width,
                        stick::Size _height,
                        stick::Size _depth,
                        stick::Size _rowPadding = 0) = 0;

    virtual void setPixelRaw(stick::Size _left, stick::Size _top, const char * _data) = 0;

    virtual void setPixelRaw(stick::Size _left,
                             stick::Size _top,
                             stick::Size _layer,
                             const char * _data) = 0;
    ...
    virtual void loadRawPixels(stick::Size _width,
                               stick::Size _height,
                               stick::Size _depth,
                               const char * _src,
                               stick::Size _rowPadding = 0) = 0;

    virtual void updateRawPixels(stick::Size _left,
                                 stick::Size _top,
                                 stick::Size _layer,
                                 stick::Size _width,
                                 stick::Size _height,
...
STICK_API stick::Result<ImageUniquePtr> decodeImage(
    const stick::ByteArray & _data, stick::Allocator & _alloc = stick::defaultAllocator());
...
STICK_API stick::Result<ImageUniquePtr> loadImage(
    const stick::String & _path, stick::Allocator & _alloc = stick::defaultAllocator());
...
class STICK_API ImageT : public Image
{
  public:
    ...
    ImageT(stick::Size _width,
           stick::Size _height,
           stick::Size _depth = 1,
           stick::Size _rowPadding = 0,
           stick::Allocator & _alloc = stick::defaultAllocator());

    ImageT(stick::Size _width,
           const ValueType * _pixels,
           stick::Size _rowPadding = 0,
           stick::Allocator & _alloc = stick::defaultAllocator());
    ...
    void resize(stick::Size _width,
                stick::Size _height,
                stick::Size _depth,
                stick::Size _rowPadding = 0) override;

    void clear();

    void loadPixels(stick::Size _width,
                    stick::Size _height,
                    const ValueType * _pixels,
                    stick::Size _rowPadding = 0);
    ...
    void updatePixels(stick::Size _left,
                      stick::Size _top,
                      stick::Size _width,
                      stick::Size _height,
                      const ValueType * _pixels);
    ...
    void loadRawPixels(stick::Size _width,
                       stick::Size _height,
                       stick::Size _depth,
                       const char * _src,
                       stick::Size _rowPadding = 0) override;

    void updateRawPixels(stick::Size _left,
                         stick::Size _top,
                         stick::Size _layer,
                         stick::Size _width,
                         stick::Size _height,
                         stick::Size _depth,
                         const char * _src) override;

    void setPixel(stick::Size _left, stick::Size _top, const ValueType * _value);

    void setPixel(stick::Size _left,
                  stick::Size _top,
                  stick::Size _layer,
    ...
    void setPixelRaw(stick::Size _left,
                     stick::Size _top,
                     stick::Size _layer,
                     const char * _data) override;
...
template <class C>
ImageT<C>::ImageT(stick::Size _width,
                  stick::Size _height,
                  stick::Size _depth,
                  stick::Size _rowPadding,
...
template <class C>
void ImageT<C>::resize(stick::Size _width,
                       stick::Size _height,
                       stick::Size _depth,
                       stick::Size _rowPadding)
{
...
template <class C>
void ImageT<C>::loadPixels(stick::Size _width,
                           stick::Size _height,
                           const ValueType * _pixels,
                           stick::Size _rowPaddingToSkip)
{
...
template <class C>
void ImageT<C>::updatePixels(stick::Size _left,
                             stick::Size _top,
                             stick::Size _width,
                             stick::Size _height,
                             const ValueType * _pixels)
                             ...
                             const ValueType * _pixels)
{
    ...
    stick::Size byteOffset =
        ((_layer * layerWidth) + _top * bytesPerRow() + _left * bytesPerPixel());
...
template <class C>
void ImageT<C>::loadRawPixels(stick::Size _width,
                              stick::Size _height,
                              stick::Size _depth,
                              const char * _src,
                              stick::Size _rowPadding)
...
template <class C>
void ImageT<C>::updateRawPixels(stick::Size _left,
                                stick::Size _top,
                                stick::Size _layer,
                                stick::Size _width,
                                stick::Size _height,
...
{
    updatePixels(
        _left, _top, _layer, _width, _height, _depth, reinterpret_cast<const ValueType *>(_src));
}
...
template <class C>
void ImageT<C>::setPixel(stick::Size _left,
                         stick::Size _top,
                         stick::Size _layer,
                         const ValueType * _value)
{
...
template <class C>
void ImageT<C>::setPixelRaw(stick::Size _left,
                            stick::Size _top,
                            stick::Size _layer,
                            const char * _data)
{
...
template <class C>
const typename ImageT<C>::Pixel & ImageT<C>::pixel(stick::Size _left,
                                                   stick::Size _top,
                                                   stick::Size _layer) const
{
    return reinterpret_cast<const Pixel &>(m_data[(_layer * bytesPerRow() * m_height) +
                                                  _top * bytesPerRow() + _left * bytesPerPixel()]);
}
...
template <class C>
typename ImageT<C>::Pixel & ImageT<C>::pixel(stick::Size _left,
                                             stick::Size _top,
                                             stick::Size _layer)
{
    return reinterpret_cast<Pixel &>(m_data[(_layer * bytesPerRow() * m_height) +
                                            _top * bytesPerRow() + _left * bytesPerPixel()]);
}
