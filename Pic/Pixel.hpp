...
namespace pic
{
    ...
    public:
        ...
        using BasePixel = BasePixelT<T, ChannelLayout2<typename C0<T>::ChannelFlag, typename C1<T>::ChannelFlag>>;
        using BasePixel::setValue;
    ...
    class STICK_API Pixel3T :
        public C0<T>,
        public C1<T>,
        public C2<T>,
        public BasePixelT<T, ChannelLayout3<typename C0<T>::ChannelFlag, typename C1<T>::ChannelFlag, typename C2<T>::ChannelFlag>>
    {
    public:

        using BasePixel = BasePixelT<T, ChannelLayout3<typename C0<T>::ChannelFlag, typename C1<T>::ChannelFlag, typename C2<T>::ChannelFlag>>;
        using BasePixel::setValue;
    ...
    class STICK_API Pixel4T :
        public C0<T>,
        public C1<T>,
        public C2<T>,
        public C3<T>,
        public BasePixelT<T, ChannelLayout4<typename C0<T>::ChannelFlag, typename C1<T>::ChannelFlag, typename C2<T>::ChannelFlag, typename C3<T>::ChannelFlag>>
    {
    public:

        using BasePixel = BasePixelT<T, ChannelLayout4<typename C0<T>::ChannelFlag, typename C1<T>::ChannelFlag, typename C2<T>::ChannelFlag, typename C3<T>::ChannelFlag>>;
        using BasePixel::setValue;
